...
export default function Footer() {
  return (
    <footer style={{ borderTop: '1px solid rgba(255,255,255,0.07)', padding: '1.5rem clamp(1.5rem,5vw,3rem)' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
          {['Privacy Policy', 'Terms of Service', 'Cookies'].map(item => (
            <a key={item} href="#"
              style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.7rem', fontFamily: 'var(--font-mono)', letterSpacing: '0.06em', textDecoration: 'none', transition: 'color 0.2s' }}
